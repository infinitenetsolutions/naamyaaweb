...
$media_data = "SELECT * FROM `Gallery` WHERE `Gallery_type`='media' && `status`=1";
$result = mysqli_query($connection, $media_data);
...
<head>
    <title>Media Gallery | Naamyaa</title>
...
<body>
    ...
    <!-- Main Area Start-->
    <section class="breadcrumb_area breadcrumb_overlay" data-background="assets/img/banners/Media.jpg">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb_section">
                        <ul class="breadcrumb-list volunteer_breadcrumb">
                            ...
                            <li><span class="active">Media Gallery</span></li>
                        </ul>
                ...
                <div class="col-md-4">
                    <div class="thumbnail">
                        <a href="<?php echo $row['link']; ?>" target="_blank">
                            ...
                            <div class="caption">
                                <p style="font-size:14px!important;"><?php echo $row['description'] ?></p>
                            </div>
                        </a>
                    </div>
                </div>
